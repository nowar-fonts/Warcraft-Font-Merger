...
def NameFont(font, region, weight, version):
	...
	font['name'] = [
		...
		},
		{
			...
			"languageID": 1033,
			"nameID": 1,
			"nameString": "Nowar Sans (漢字, 仮名 and 한글) {}".format(region) if isStdStyle else "Nowar Sans (漢字, 仮名 and 한글) {} {}".format(region, weight)
		},
		{
			"platformID": 3,
			"encodingID": 1,
		...
		},
		{
			...
			"languageID": 1033,
			"nameID": 3,
			"nameString": "Nowar Sans (漢字, 仮名 and 한글) {} {} {}".format(region, weight, version)
		},
		{
			"platformID": 3,
			"encodingID": 1,
			"languageID": 1033,
			"nameID": 4,
			"nameString": "Nowar Sans (漢字, 仮名 and 한글) {} {}".format(region, weight)
		},
		{
			"platformID": 3,
			"encodingID": 1,
		...
		},
		{
			...
			"languageID": 1033,
			"nameID": 16,
			"nameString": "Nowar Sans (漢字, 仮名 and 한글) {}".format(region)
		},
		{
			"platformID": 3,
			"encodingID": 1,
